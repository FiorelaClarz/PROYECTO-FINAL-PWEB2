...
import { RouterLink, RouterModule, Routes, RouterOutlet } from '@angular/router';
...
@Component({
  ...
  imports: [RouterOutlet, HomeComponent, RouterLink, NavBarComponent, FooterComponent, CommonModule, MenuComponent, FormsModule, RegisterComponent, LoginComponent, HttpClientModule, TableListComponent, ReservationFormComponent],
  providers: [ApiService, ReservationService, AuthService],
